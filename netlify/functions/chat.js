    ...
    "findings": [
      {
        ...
        "body": "Klinisk forklaring basert KUN på det brukeren faktisk har sagt. Forklar mekanismen presist. Bruk <strong>nøkkelbegreper</strong>."
      }
    ],
    "lifestyle": {
      "title": "Slik ble dette til",
      "body": "Beskriv KUN livsstilsfaktorer brukeren selv har bekreftet."
    },
    "confirmatory": {
      "title": "Det du sannsynligvis kjenner igjen",
      "body": "3-4 bekreftende observasjoner – wow-effekten."
    },
    "summary": "Oppsummering som trekker alle trådene. Bruk brukerens egne ord aktivt.",
    "confidence_note": "Kort forklaring på hvorfor confidence er akkurat dette tallet",
    "program_desc": "Hva Akt 1 fokuserer på basert på funnene",
    "exercises": [
      {"name": "Øvelsenavn", "detail": "Beskrivelse, dosering og HVORFOR denne øvelsen er valgt"}
    ]
  }
}`;
